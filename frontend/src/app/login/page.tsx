    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-scale-in">
        <div className="text-center mb-10">
          ...
          <p className="text-text-secondary text-sm">Sign in to manage your classroom activity.</p>
        </div>
        ...
        <div className="mt-10 text-center">
          <p className="text-sm text-text-muted">
            New to QuickPoll? <span className="text-primary font-bold">Contact your Administrator</span>
          </p>
          <div className="mt-4 flex items-center justify-center gap-2 px-6 py-2 bg-surface-elevated/40 rounded-full w-fit mx-auto border border-glass-border">
            ...
            <span className="text-[10px] font-bold text-text-secondary uppercase tracking-widest">System Operational</span>
          </div>
        </div>
      </div>
    </div>
